...
function validasi(){
	...
	<div class="row">
      ...
      <?php foreach ($libur as $data) ?>

<center>
<h3>Hari Libur</h3><br>
<form action="<?php echo site_url()?>/libur/lihat_libur" method="POST" enctype="multipart/form-data" onsubmit="return validasi()">
<table style="font-size:18px">
<tr><td>Tanggal</td><td>&nbsp&nbsp:</td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;</td><td><input required type="date" value="" class="form-control" name="tanggal" id="tanggal"></td>
