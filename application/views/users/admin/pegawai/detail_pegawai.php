...
<script src="<?=base_url('assets/plugins/jQueryUI/jquery-ui-1.10.3.min.js');?>"></script>
	...
	<div class="row">
		<div class="col-md-12 clearfix">
			<form role="form" method="post" action="<?php echo site_url()?>/admin/update_pegawai">
				...
				<table class="table table-bordered">
					...
					<tr>
						<td>NIP</td>
						<td> 
							<div class='col-sm-3'><input readonly type="text" name="nip" class="form-control" id="nip" value="<?php echo $row->nip; ?>" placeholder="nip" class="form-control" id="nip" required ></div>
							</div>
						</td>
					</tr>
					<tr>
						<td>Nama Lengkap</td>
						<td> 
							<div class='col-sm-3'><input type="text" name="nama" class="form-control" id="nama" value="<?php echo $row->nama; ?>" placeholder="nama" class="form-control" id="nama" required ></div>
						</td>
					</tr>
					<tr>
						<td>Golongan</td>
