...
<form action="<?php echo site_url()?>/admin/data_pegawai" method="GET" enctype="multipart/form-data" onsubmit="return validasi">
<table style="font-size:12px">
<tr>
<td>Pilih Dinas/ Unit Kerja<div id="jenis"></td>
    <td>&nbsp&nbsp:</td>
