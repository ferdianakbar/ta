...
<center>
<h3>Input Cuti</h3><br>
<form action="<?php echo site_url()?>/cuti/tambah_cuti" method="POST" enctype="multipart/form-data" onsubmit="return validasi()">
<table style="font-size:18px">
<tr><td>NIP</td><td>&nbsp&nbsp:</td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;</td><td><input required type="textfield" value= "<?php echo $data->nip; ?>" class="form-control" readonly name="nip" id="nip"></td>
<tr><td>Nama</td><td>&nbsp&nbsp:</td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;</td><td><input required type="textfield" value= "<?php echo $data->nama; ?>" class="form-control" readonly name="nama" id="nama"></td>
