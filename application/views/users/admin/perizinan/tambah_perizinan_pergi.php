...
<form action="<?php echo site_url()?>/perizinan/lihat_data_izin" method="POST" enctype="multipart/form-data" onsubmit="return validasi()">
...
<tr>
<td>Nama Lengkap</td><td>&nbsp&nbsp</td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;</td><td><input required type="textfield" class="form-control" value= "<?php echo $data->nama; ?>" readonly name="nama"id="nama"></td>
</tr>
