...
<?php 
  ...
  if($data->status == $disetujui):?>
      <div class="btn">
          <a href="<?php echo site_url().'/perizinan/update_izin/'.$data->nip;?>" data-toggle="tooltip" class="label label-success">APPROVE</a>
          <br>
          <a href="<?php echo site_url().'/perizinan/tolak_izin/'.$data->nip;?>" data-toggle="tooltip" class="btn btn-xs btn-danger">TOLAK</a>
      </div></td>
  <?php else: ?>
