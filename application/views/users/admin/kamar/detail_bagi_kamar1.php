...
<tr>
<td>SISA / KAPASITAS</td><td>&nbsp&nbsp</td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;</td><td>&nbsp&nbsp<?php echo $kap->sisa;?>&nbsp&nbsp / &nbsp&nbsp<?php echo $kap->kapasitas;?></td>
</tr>
			</table>
			</center>			
...
<h3>---Detail Pembagian Kamar---</h3>
	  <table class="shortcode table table-bordered">
		...
		<tbody>
		<?php $nourut1=0;
foreach ($santri1 as $data1) {
$nourut1++;?>
				<tr>
					<td><?php echo $nourut1 ?></td>
					<td><?php echo $data1->photo!=''?'<img src="'.base_url().'/upload/foto_profil/'.$data1->photo.'" width="70" height="70">':'<img src="'.base_url().'/upload/foto_users/noface.png'.'"width="70" height="70">'?></td>
					...
					<td><?php echo $data1->tempat_lahir;?>,<?php echo date("d-M-Y",strtotime($data1->tanggal_lahir))?></td>
						<td class="text-center">
                                    <div class="btn">
                                       <a href="<?php echo site_url().'/kamar/hapus_detail_kamar/'.$data1->nis,$detail->id_detail_kamar,$detail->id_kamar;?>" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                    </div></td>
						</tr>
						<?php } ?>
	   ...
	   <a  href="<?php echo site_url().'/kamar/lihat_detail_kamar'?>"data-toggle="tooltip" class="btn btn-danger  btn-sm">SIMPAN</a>
