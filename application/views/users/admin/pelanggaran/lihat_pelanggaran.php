  ...
  $(function () {
   ...
   <!-- /.box-header -->
	...
	<div class="box-header">
				...
				<form method="POST" action="<?php echo site_url()?>/pelanggaran/lihat_pelanggaran">
				<table>
				<tr>
...
<tr><td><br><?php if($_POST){
 $bln = $_POST['bln']."-"; 
 $thn=$_POST['thn']; ?>
 <a style="float:left" target="_blank"href="<?php echo site_url()?>/pelanggaran/cetak/<?php echo $bln?>/<?php echo $thn?>"> <b>Cetak Laporan</b> </a>	
<?php }else{ ?>
	 -
