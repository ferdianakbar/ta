			...
			<form role="form" method="post" action="<?php echo site_url()?>/unit_kerja/update_unitkerja">				
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td> 
							<div class='col-sm-4'>
							<input readonly type="text" name="id_ins" class="form-control" id="id_ins" value="<?php echo $this->session->userdata('id_ins');?>" placeholder="id_ins" class="form-control"  required ></div>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td> 
							<div class='col-sm-4'>
							<input readonly type="text" name="nama_ins" class="form-control" id="nama" value="<?php echo $data->nama_ins; ?>" placeholder="id_ins" class="form-control"  required ></div>
							</div>
						</td>
					</tr>
					<tr>
