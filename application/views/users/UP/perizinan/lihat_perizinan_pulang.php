...
<script type="text/javascript">
  $(function () {
   ...
   <!-- /.box-header -->
	...
	<div class="box-header">
				...
				<form method="POST" action="<?php echo site_url()?>/perizinan/lihat_perizinan_pulang">
				<table>
				<tr>
 ...
 $bln = $_POST['bln']."-"; 
 $thn=$_POST['thn']; ?>
 <a style="float:left" target="_blank"href="<?php echo site_url()?>/perizinan/cetak_pulang/<?php echo $bln?>/<?php echo $thn?>"> <b>Cetak Laporan</b> </a>	
<?php }else{ ?>
	 -
