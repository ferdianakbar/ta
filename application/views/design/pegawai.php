              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <?php echo $this->session->userdata('photo')!=''?'<img src="'.base_url().'assets/upload/foto_user/'.$this->session->userdata('photo').'"class="img-circle" alt="User Image">':'<img src="'.base_url().'/upload/foto_users/noface.png'.'"class="img-circle" alt="User Image">'?>
                    <p>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <?php echo $this->session->userdata('photo')!=''?'<img src="'.base_url().'assets/upload/foto_user/'.$this->session->userdata('photo').'"class="img-circle" alt="User Image">':'<img src="'.base_url().'/upload/foto_users/noface.png'.'"class="img-box" alt="User Image">'?>
            </div>
            ...
            <li class="treeview">
              ...
              <!--data pegawai-->
                <ul class="treeview-menu">
			                  <li class="">
                            <a href="<?=site_url('pegawai/detail_pegawai');?>"><i class="fa fa-user"></i>Data Pegawai</a>
			                  </li>         
                ...
                <!--Data unit kerja-->
                  ...
                  <a herf="#"> 
                      <i class="fa fa-group"></i><span>Data Unit Kerja</span> <i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="treeview-menu">
                          <li class="">
                              <a href="<?=site_url('pegawai/data_unitkerja');?>"><i class="fa fa-minus"></i>Unit Kerja</a>
                          </li>
                </li>
                </ul>
                <!--data user-->
                ...
                <a herf="#">
                    <i class="fa fa-lock"></i><span>User</span> <i class="fa fa-angle-right pull-right"></i></a>
                      <ul class="treeview-menu">
                        <li class=""><a href="<?=site_url('pegawai/ganti_pass');?>"><i class="fa fa-minus"></i>Ganti Password</a>
                        </li>
                      </ul>              
              </li>                   
            </li>
...
<!-- Menu Presensi-->
            <li class="treeview">
              <a href="#">
                 <i class="far fa-chart-bar"></i> <span>presensi</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
              <li class="treeview">
                <a herf="#"> 
                    ...
                    <ul class="treeview-menu">
                    <li class="">
                          <a href="<?=site_url('pegawai/tambah_perizinan_pergi');?>"><i class="fa fa-minus"></i>Formulir</a>
			               </li>
                       <li class="">
                          <a href="<?=site_url('pegawai/data_izin');?>"><i class="fa fa-minus"></i>Daftar Ijin</a>
			                 </li>
                    </ul>                   
              </li>
              <li class="treeview">
              <a href="<?=site_url('pegawai/data_libur');?>"><i class="fa fa-calendar"></i><span>Hari Libur</span></i></a> 
              </li>
              <li class="treeview">
                  <a href="<?=site_url('pegawai/detail_jamkerja');?>"><i class="fa fa-clock-o"></i>Daftar Jam Kerja</a>                  
              </li>
              <li class="treeview">
                <a herf="#"> 
                    ...
                    <ul class="treeview-menu">
			                 <li class="">
                       <a href="<?=site_url('pegawai/tambah_cuti');?>"><i class="fa fa-minus"></i>Tambah Cuti</a>
                       </li>
                       <li class="">
                       <a href="<?=site_url('pegawai/lihat_cuti');?>"><i class="fa fa-minus"></i>Daftar Cuti</a>
			                 </li>
                    </ul>                  
              </li>
              <li class="treeview">
              <a href="<?=site_url('pegawai/presensi_manual');?>"><i class="fa fa-minus"></i>Presensi Manual</a>
...
-->				</li>
          ...
          <li class="treeview">
              <a href="#">
                <span>Penilaian Kinerja</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
			              <li class=""><a href="<?=site_url('pegawai/showNip');?>"><i class="fa fa-minus"></i>Kuisioner PKP</a>
			              </li>                      
              </ul>
              <ul class="treeview-menu">
			              <li class=""><a href="<?=site_url('pegawai/hasil');?>"><i class="fa fa-minus"></i>Hasil Kuisioner</a>
			              </li>                      
              </ul>
          <li class="treeview">
              <a href="#">
