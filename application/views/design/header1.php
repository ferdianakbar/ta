            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php echo $this->session->userdata('photo')!=''?'<img src="'.base_url().'/upload/foto_profil/'.$this->session->userdata('photo').'"class="user-image" alt="User Image">':'<img src="'.base_url().'/upload/foto_profil/noface.png'.'"class="user-image" alt="User Image">'?>
                  <span class="hidden-xs"><?php echo $this->session->userdata('nama_lengkap');?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <?php echo $this->session->userdata('photo')!=''?'<img src="'.base_url().'/upload/foto_profil/'.$this->session->userdata('photo').'"class="img-circle" alt="User Image">':'<img src="'.base_url().'/upload/foto_profil/noface.png'.'"class="img-circle" alt="User Image">'?>
                    <p>
                  ...
                  <li class="user-footer">
                      <a href="<?php echo site_url().'/calon_santri/edit_pass/'.$this->session->userdata('nisn');?>" class="btn btn-default btn-flat">Ganti Password</a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
		  ...
		  <ul class="sidebar-menu">
            <li class="header"></li>
            <li>
              <a href="<?=site_url('calon_santri');?>">
                <i class="fa fa-home"></i> <span>Home</span>
              </a>
            </li>
             <li>
             <a href="<?php echo site_url().'/calon_santri/formdaftar/'.$this->session->userdata('nisn');?>">
                <i class="fa fa-pencil"></i> <span >Formulir Pendaftaran</span>
              </a>
            </li>
			 <li>
               <a href="<?php echo site_url().'/calon_santri/lihat_formulir/'.$this->session->userdata('nisn');?>" target="_blank">
                <i class="fa fa-file-o"></i> <span>Lihat Formulir</span>
              </a>
            </li>
			 <li>
              <a href="<?php echo site_url().'/calon_santri/lihat_kelulusan/'.$this->session->userdata('username');?>" target="_blank">
                <i class="fa fa-star"></i> <span>Pengumuman Kelulusan</span>
              </a>
            </li>
