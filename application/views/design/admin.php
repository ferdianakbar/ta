              ...
              <ul class="treeview-menu">
                <li class="treeview">
                  <a herf="#"> 
                    <i class="fa fa-group"></i><span>Data Pegawai</span> <i class="fa fa-angle-right pull-right"></i></a>
                      <ul class="treeview-menu">
			                  <li class="">
                            <a href="<?=site_url('admin/lihat_data_pegawai');?>"><i class="fa fa-minus"></i>Data Pegawai</a>
			                  </li>
			                  <li class="">
                        <a href="<?=site_url('admin/edit_data_pegawai');?>"><i class="fa fa-minus"></i>Edit Pegawai</a>
			                  </li>
                        <li class="">
                        <a href="<?=site_url('admin/tambah_pegawai');?>"><i class="fa fa-minus"></i>Tambah Pegawai</a>
			                  </li>
                      </ul>                  
                </li>
                ...
                <li class="treeview">
                  <a herf="#"> 
                      <i class="fa fa-group"></i><span>Data Unit Kerja</span> <i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="treeview-menu">
                          <li class="">
                              <a href="<?=site_url('unit_kerja/showIns');?>"><i class="fa fa-minus"></i>Unit Kerja</a>
                          </li>
                          <li class="treeview">
                          <a href="<?=site_url('kegiatan/getIns');?>">
                ...
                <a herf="#">
                    <i class="fa fa-lock"></i><span>User</span> <i class="fa fa-angle-right pull-right"></i></a>
                      <ul class="treeview-menu">
			                  <li class=""><a href="<?=site_url('admin/data_users');?>"><i class="fa fa-minus"></i>Daftar User</a>
			                  </li>
			                  <li class=""><a href="<?=site_url('admin/tambah_users');?>"><i class="fa fa-minus"></i>Tambah User</a>
			                  </li>
                        <li class=""><a href="<?=site_url('admin/ganti_pass');?>"><i class="fa fa-minus"></i>Ganti Password</a>
                        </li>
                      </ul>              
              </li>                   
            </li>
...
<!-- Menu Presensi-->
            <li class="treeview">
              ...
              <li class="treeview">
                <a herf="#"> 
                    ...
                    <ul class="treeview-menu">
                    <li class="">
                          <a href="<?=site_url('perizinan/tambah_perizinan');?>"><i class="fa fa-minus"></i>Formulir</a>
			               </li>
                     <li class="">
                          <a href="<?=site_url('perizinan/aproval');?>"><i class="fa fa-minus"></i>Approval</a>
                     </li>
                       <li class="">
                          <a href="<?=site_url('perizinan/data_izin');?>"><i class="fa fa-minus"></i>Daftar Ijin</a>
			                 </li>
                    </ul>                   
              </li>
      ...
      <li class="treeview">
                <a herf="#"> 
                    ...
                    <ul class="treeview-menu">
			<li class=""><a href="<?=site_url('libur/tambah_libur');?>"><i class="fa fa-minus"></i>Set Hari Libur</a>
			</li>
			<li class=""><a href="<?=site_url('libur/data_libur');?>"><i class="fa fa-minus"></i>Daftar Hari Libur</a>
			</li>
      </ul>                   
              </li>
              <li class="treeview">
                  <a href="<?=site_url('jam_kerja/daftar_jamkerja');?>"><i class="fa fa-clock-o"></i>Daftar Jam Kerja</a>                  
              </li>
              <li class="treeview">
                <a herf="#"> 
                    ...
                    <ul class="treeview-menu">
			                 <li class="">
                       <a href="<?=site_url('cuti/nip_cuti');?>"><i class="fa fa-minus"></i>Tambah Cuti</a>
                       </li>
                       <li class="">
                       <a href="<?=site_url('cuti/approval_cuti');?>"><i class="fa fa-minus"></i>Approval Cuti</a>
			                 </li>
                       <li class="">
                       <a href="<?=site_url('cuti/lihat_cuti');?>"><i class="fa fa-minus"></i>Daftar Cuti</a>
			                 </li>
                    </ul>                  
              </li>
              <li class="treeview">
                <a herf="#"> 
                    ...
                    <ul class="treeview-menu">
			                 <li class="">
                       <a href="<?=site_url('presensi/presensi_manual');?>"><i class="fa fa-minus"></i>Presensi Manual</a>
			                 </li>
                       <li class="">
                       <a href="<?=site_url('presensi/showPresman');?>"><i class="fa fa-minus"></i>approve presensi</a>
			                 </li>
                    </ul>                  
              </li>
              <li class="treeview">
              <a href="<?=site_url('presensi/data_presensi');?>"> 
                    <i class="fa fa-file"></i><span>Data Presensi</span> <i class="fa fa-angle-right pull-right"></i>
                </a>
...
-->				</li>
          ...
          <li class="treeview">
              <a href="#">
                 <i class="fa fa-circle"></i> <span>Capaian Kinerja</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
			              <li class=""><a href="<?=site_url('penilaian_kinerja/showNip');?>"><i class="fa fa-minus"></i>Kegiatan</a>
			              </li>                      
              </ul>
              <ul class="treeview-menu">
			              <li class=""><a href="<?=site_url('penilaian_kinerja/hasil');?>"><i class="fa fa-minus"></i>Keluaran</a>
			              </li>                      
              </ul>
              </li>
          <li class="treeview">
              ...
              <ul class="treeview-menu">
			              <li class=""><a href="<?=site_url('penilaian_kinerja/showNip');?>"><i class="fa fa-minus"></i>Kuisioner PKP</a>
			              </li>                      
              </ul>
              <ul class="treeview-menu">
			              <li class=""><a href="<?=site_url('penilaian_kinerja/hasil');?>"><i class="fa fa-minus"></i>Hasil Kuisioner</a>
			              </li>                      
              </ul>
          <li class="treeview">
              <a href="#">
